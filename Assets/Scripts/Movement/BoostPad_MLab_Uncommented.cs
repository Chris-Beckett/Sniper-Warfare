...
public class BoostPad_MLab_Uncommented : MonoBehaviour
{
    ...
    private PlayerMovementAdvancedDone pm = null;
    ...
    {
        if (other.GetComponentInParent<PlayerMovementAdvancedDone>() != null)
        {
            pm = other.GetComponentInParent<PlayerMovementAdvancedDone>();
